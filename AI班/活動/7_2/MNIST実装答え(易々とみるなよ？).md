...
今回はインターネットで調べれば、できる難易度なので、易々と答えに頼らず、頑張ってみようね
...
if __name__ == "__main__":
    ...
    # --- 3. 学習の実行 ---
    train_loss_history, val_loss_history = train_model(model, train_loader, validation_loader, criterion, optimizer, EPOCHS)
